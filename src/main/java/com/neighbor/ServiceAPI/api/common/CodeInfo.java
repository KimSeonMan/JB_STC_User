 ...
 * <p/>
 */
public class CodeInfo extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(CodeInfo.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			List codeList = commonService.selectCodeList(mapParameter);
			resultData.put("codeList", codeList);
