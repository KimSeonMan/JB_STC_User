 ...
 * <p/>
 */
public class CarMngDetail extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(CarMngDetail.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			Map carMngDetail = bassInfoService.carMngDetail(mapParameter);
			resultData.put("carMngDetail", carMngDetail);
