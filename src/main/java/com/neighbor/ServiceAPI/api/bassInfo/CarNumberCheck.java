 ...
 * <p/>
 */
public class CarNumberCheck extends AbsQuery<Map> {
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			Map checkingVhicleNo = bassInfoService.carNumberCheck(mapParameter);
			resultData.put("carNumberCheck", checkingVhicleNo);
