 ...
 * <p/>
 */
public class HadicapMngList extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(HadicapMngList.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			List hadicapMngListCount = bassInfoService.selectHadicapMngListCount(mapParameter);
			
			resultData.put("hadicapMngList", hadicapMngList);
			resultData.put("hadicapMngListCount", hadicapMngListCount);
