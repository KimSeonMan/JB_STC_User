 ...
 * <p/>
 */
public class CarMngUpdate extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(CarMngUpdate.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			bassInfoService.carMngUpdate(mapParameter); 
