 ...
 * <p/>
 */
public class MemberShipUpdate extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(MemberShipUpdate.class);
	...
	enum OptionParam
	{
		...
		ASSTN_NEED_AT, DS_MLRD_POSBL_AT, ATCHMNFL_REAL_NM, BASIC_LIVELIHOOD_AT
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			//회원정보 수정
			loginService.memberShipUpdate(mapParameter);
