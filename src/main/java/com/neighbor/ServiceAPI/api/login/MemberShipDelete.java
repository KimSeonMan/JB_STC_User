 ...
 * <p/>
 */
public class MemberShipDelete extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(MemberShipDelete.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			//회원탈퇴
			loginService.memberShipDelete(req.getParameter(MustParam.MBER_ID.name()).toString().split(","));
