 ...
 * <p/>
 */
public class NoticeDelete extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(NoticeDelete.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			userSiteTemplateService.noticeDelete(req.getParameter(MustParam.NOTICE_NO.name()).toString().split(",")); 
