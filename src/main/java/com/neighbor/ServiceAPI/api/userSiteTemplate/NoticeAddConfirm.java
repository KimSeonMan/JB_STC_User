 ...
 * <p/>
 */
public class NoticeAddConfirm extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(NoticeAddConfirm.class);
	...
	enum OptionParam
	{
		CNTNTS_TYPE2_CD, CNTNTS_CLS_CD, CNTNTS_NO, CNTER_CD
	}	
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			List noticeAddConfirm = userSiteTemplateService.noticeAddConfirm(mapParameter);
			resultData.put("noticeAddConfirm", noticeAddConfirm);
