 ...
 * <p/>
 */
public class ReplyAdd extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(ReplyAdd.class);
	...
	enum MustParam
	{
		CNTNTS_TYPE2_CD, CNTNTS_CLS_CD, CNTNTS_NO, NOTICE_NO, REPLAY, CNTER_CD
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			userSiteTemplateService.replyInsert(mapParameter);
