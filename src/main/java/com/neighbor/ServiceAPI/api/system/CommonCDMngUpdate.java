 ...
 * <p/>
 */
public class CommonCDMngUpdate extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(CommonCDMngUpdate.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			mngrService.commonCDMngUpdate(mapParameter);
