 ...
 * <p/>
 */
public class StcMngDelete extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(StcMngDelete.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			stcMngService.stcMngDelete(mapParameter);
