 ...
 * <p/>
 */
public class StcMngModify extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(StcMngModify.class);
	...
	enum OptionParam
	{
		...
		, LC_CRDNT_X, LC_CRDNT_Y, ADRES, ADRES_DETAIL, AREA_NM_EN, ZIP_CODE, MANAGE_AREA
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			stcMngService.stcMngModify(mapParameter);
