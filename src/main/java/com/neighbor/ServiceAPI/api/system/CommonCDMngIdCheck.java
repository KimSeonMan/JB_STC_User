 ...
 * <p/>
 */
public class CommonCDMngIdCheck extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(CommonCDMngIdCheck.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			Map commonCDMngIdCheck = mngrService.selectCommonCDMngIdCheck(mapParameter);
			resultData.put("confirm", commonCDMngIdCheck);
