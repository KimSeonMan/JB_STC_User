 ...
 * <p/>
 */
public class CommonCDMngDetail extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(CommonCDMngDetail.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			Map commonCDMngDetail = mngrService.selectCommonCDMngDetail(mapParameter);
			resultData.put("commonCDMngDetail", commonCDMngDetail);
