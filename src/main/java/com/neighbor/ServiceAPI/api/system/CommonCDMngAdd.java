 ...
 * <p/>
 */
public class CommonCDMngAdd extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(CommonCDMngAdd.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			mngrService.commonCDMngInsert(mapParameter);
