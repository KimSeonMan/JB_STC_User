...
public class GetToDayUseStatList extends AbsQuery<Map>{

	private static final Log logger = LogFactory.getLog(GetToDayUseStatList.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		...
		try{
			...
			List list = statsService.getToDayUseStatList(mapParameter.get("searchDate").toString());
