...
public class CarInfoShareSave extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(CarInfoShareSave.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			stndSettingMngService.carInfoShareSave(mapParameter);
