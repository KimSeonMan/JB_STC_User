...
public class ChargeForUsingInfo extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(ChargeForUsingInfo.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			List chargeForUsingInfo = stndSettingMngService.getChargeForUsingInfo(mapParameter);
			
			resultData.put("chargeForUsingInfo", chargeForUsingInfo);
