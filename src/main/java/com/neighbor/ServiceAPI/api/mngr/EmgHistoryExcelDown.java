 ...
 * <p/>
 */
public class EmgHistoryExcelDown extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(EmgHistoryExcelDown.class);
	...
	enum OptionParam
	{
		searchCNTER_CD, searchNm, searchStartDate, searchEndDate
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			List emgHistoryList = mngrService.selectEmgHistoryList(mapParameter);
			List emgHistoryListCount = mngrService.selectEmgHistoryListCount(mapParameter);
			
			List searchCnter = bassInfoService.selectSearchCnterList(mapParameter);
			
			resultData.put("searchCnter", searchCnter);
			resultData.put("emgHistoryList", emgHistoryList);
			resultData.put("emgHistoryListCount", emgHistoryListCount);
