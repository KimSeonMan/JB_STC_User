 ...
 * <p/>
 */
public class MenuMngSelectboxList extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(MenuMngSelectboxList.class);
	...
	enum OptionParam
	{
		MENU_GUBN, PARENT_MENU_ID, BOARD_YN
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			List menuMngSelectboxList = mngrService.menuMngSelectboxList(mapParameter);
			resultData.put("menuMngSelectboxList", menuMngSelectboxList);
