 ...
 * <p/>
 */
public class QestnarMngDelete extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(QestnarMngDelete.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			mngrService.qestnarMngDelete(req.getParameter(MustParam.SURVEY_ID.name()).toString().split(","));
