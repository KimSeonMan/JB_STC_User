 ...
 * <p/>
 */
public class ContentsMngAdd extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(ContentsMngAdd.class);
	...
	enum MustParam
	{
		MENU_ID, CNTNTS_TYPE1_CD, CNTNTS_TYPE2_CD, FILE_YN, CNTNTS_CLS_CD, CNTER_CD
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			mngrService.contentsMngInsert(mapParameter);
