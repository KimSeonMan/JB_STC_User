 ...
 * <p/>
 */
public class ContentsMngDelete extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(ContentsMngDelete.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			mngrService.contentsMngDelete(req.getParameter(MustParam.CNTNTS_NO.name()).toString().split(","));
