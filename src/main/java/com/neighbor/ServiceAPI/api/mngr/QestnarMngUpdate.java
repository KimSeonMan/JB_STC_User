 ...
 * <p/>
 */
public class QestnarMngUpdate extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(QestnarMngUpdate.class);
	...
	enum MustParam
	{
		SURVEY_ID, SURVEY_TITLE, SURVEY_ST_DATE, SURVEY_EN_DATE, TARGET_USER_CD, 
		MAIN_VIEW_YN, SURVEY_REMARK
	}
	
	enum OptionParam
	{
		SURVEY_TYPE_CD, SURVEY_CHOICE_CD, SURVEY_GBN_CD, SURVEY_CTNT
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			mngrService.qestnarMngInsert(mapParameter, "U");
