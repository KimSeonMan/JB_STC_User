 ...
 * <p/>
 */
public class MenuMngDetail extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(MenuMngDetail.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			Map menuMngDetail = mngrService.selectMenuMngDetail(mapParameter);
			resultData.put("menuMngDetail", menuMngDetail);
