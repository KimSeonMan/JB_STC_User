 ...
 * <p/>
 */
public class SiteMngUpdate extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(SiteMngUpdate.class);
	...
	enum MustParam
	{
		SITE_NO, SITE_NAME, SITE_SEQ, LINKED_URL, CNTER_CD
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			mngrService.siteMngUpdate(mapParameter);
