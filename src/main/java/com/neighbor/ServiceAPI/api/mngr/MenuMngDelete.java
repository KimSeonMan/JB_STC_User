 ...
 * <p/>
 */
public class MenuMngDelete extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(MenuMngDelete.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			//메뉴관리 사용중지
			mngrService.menuMngDelete(req.getParameter(MustParam.GUBN.name()).toString(), req.getParameter(MustParam.MENU_ID.name()).toString().split(","));
