 ...
 * <p/>
 */
public class QestnarMngAdd extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(QestnarMngAdd.class);
	...
	enum MustParam
	{
		SURVEY_TITLE, SURVEY_ST_DATE, SURVEY_EN_DATE, TARGET_USER_CD, 
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			mngrService.qestnarMngInsert(mapParameter, "I");
