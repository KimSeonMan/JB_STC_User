 ...
 * <p/>
 */
public class ContentsMngDetail extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(ContentsMngDetail.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			Map contentsMngDetail = mngrService.selectContentsMngDetail(mapParameter);
			resultData.put("contentsMngDetail", contentsMngDetail);
