 ...
 * <p/>
 */
public class MenuMngAccessList extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(MenuMngAccessList.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			List menuMngAccessList = mngrService.selectMenuMngAccessList(mapParameter);
			resultData.put("menuMngAccessList", menuMngAccessList);
