 ...
 * <p/>
 */
public class SiteMngDetail extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(SiteMngDetail.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			Map siteMngDetail = mngrService.selectSiteMngDetail(mapParameter);
			
			resultData.put("siteMngDetail", siteMngDetail);
