 ...
 * <p/>
 */
public class MenuMngDoubleAddChk extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(MenuMngDoubleAddChk.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			Map menuMngDoubleChk = mngrService.menuMngDoubleChk(mapParameter);
			resultData.put("confirm", menuMngDoubleChk);
