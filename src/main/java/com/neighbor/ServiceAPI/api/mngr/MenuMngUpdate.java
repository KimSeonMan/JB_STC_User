 ...
 * <p/>
 */
public class MenuMngUpdate extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(MenuMngUpdate.class);
	...
	enum MustParam
	{
		MENU_LEVEL, PARENT_MENU_ID, MENU_ID, MENU_NAME, MENU_SEQ, USE_YN, MENU_GUBN, CNTER_CD
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			//메뉴관리 사용중지
			mngrService.menuMngUpdate(mapParameter);
