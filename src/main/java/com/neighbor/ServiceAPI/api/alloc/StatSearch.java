 ...
 * <p/>
 */
public class StatSearch extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(StatSearch.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			List statSearch = allocService.selectStatSearch(mapParameter);
			resultData.put("statSearch", statSearch);
