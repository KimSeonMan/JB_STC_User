 ...
 * <p/>
 */
public class CarAllocDetail extends AbsQuery<Map> {
	private static final Log logger = LogFactory.getLog(CarAllocDetail.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			Map carAllocDetail = allocService.selectCarAllocDetail(mapParameter);
			resultData.put("carAllocDetail", carAllocDetail);
