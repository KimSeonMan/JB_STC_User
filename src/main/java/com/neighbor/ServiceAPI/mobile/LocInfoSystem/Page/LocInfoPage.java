package com.neighbor.ServiceAPI.mobile.LocInfoSystem.Page;

public class LocInfoPage {
	/** 현재 페이지 번호. */
	 ...
	 */
	public LocInfoPage(Integer pageNo, Integer total) {
		this.pageNo = pageNo;
		this.total = total;
	...
	private final void setPageCount() {
		this.pageCount = this.total / 15 + (this.total % 15 != 0 ? 1 : 0);
	}
	...
	private final void setOffset() {
		this.offset = ((this.pageNo - 1) * 15) + 1;
	}
