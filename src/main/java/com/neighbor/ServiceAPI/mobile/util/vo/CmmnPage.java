package com.neighbor.ServiceAPI.mobile.util.vo;

public class CmmnPage {
	 ...
	 */
	public CmmnPage(Integer pageNo, Integer total) {
		this.pageNo = pageNo;
		this.total = total;
	...
	public String toString() {
		return "CmmnPage [pageNo=" + pageNo + ", total=" + total + ", pageCount=" + pageCount + ", offset=" + offset
				+ ", limit=" + limit + "]";
	}
