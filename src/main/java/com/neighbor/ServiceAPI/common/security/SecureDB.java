package com.neighbor.ServiceAPI.common.security;
...
public class SecureDB {
	...
	* @exception Exception
	*/
	public static SDBCrypto dbConfig() throws Exception {
	...
	* @exception Exception
	*/
	public static String encryptAria256(String param) throws Exception {
		String encData = "";
		try {
	...
	* @exception Exception
	*/
	public static String decryptAria256(String param) throws Exception {
		String decData = "";
		try {
			SDBCrypto crypto = dbConfig();
	...
	* @exception Exception
	*/
	public static String encryptSha256(String param) throws Exception {
		String encData = "";
		try {
			SDBCrypto crypto = dbConfig();
