...
<tr>
    <td height="25" onClick="clickshow(1)" style="cursor:hand;">&nbsp;<img src="./img/go_menu_open.gif" border="0">&nbsp;<b>복합과세</b></td>
</tr>
<tr>
    <td bgcolor="#FFFFFF">
    <span id="block1" style="DISPLAY:none; MARGIN-LEFT:0px; CURSOR:hand">
        ...
        <tr>
            <td height="20">&nbsp;&nbsp;<img src="./img/go_menu_minus2.gif" border="0">&nbsp;<a href="javascript:f_gotomain('normal/order.jsp');">결제</a></td>
        </tr>
        <tr>
             <td background="./img/dot0001.gif"></td>
        </tr>
        <tr>
            <td height="20">&nbsp;&nbsp;<img src="./img/go_menu_minus2.gif" border="0">&nbsp;<a href="javascript:f_gotomain('mgr/mgr.jsp');">변경</a></td>
        </tr>
        <tr>
             <td background="./img/dot0001.gif"></td>
        </tr>
