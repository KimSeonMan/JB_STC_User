...
<head>
	...
	<script type="text/javascript" src="/js/tscp/mngr/emgHistoryMng.js"></script>
		...
		<div class="acticle">
			...
			<table class="sTable01">
				...
				<tr>
					<th>검색일</th>
					<td colspan="3">
						<input type="text" class="inp datepicker inp-float" id="searchStartDate" readOnly/>
						<span class="etxt">~</span>
						<input type="text" class="inp datepicker inp-float" id="searchEndDate" readOnly/>
						<a href="javascript:void(0)" class="btn01" id="searchBtn">찾기</a>
					</td> 
				</tr>
			</table>

			<p class="tit01">긴급호출이력 목록</p>
			<div class="boardHeader">
				<div class="fl"></div>
				<div class="btn"> 
					<a href="javascript:void(0)" id="excelDown">Excel저장</a> 
				</div>
			</div>
			<form id="listTable">
