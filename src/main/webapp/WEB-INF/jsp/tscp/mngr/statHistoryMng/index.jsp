...
<head>
	...
	<script type="text/javascript" src="/js/tscp/mngr/statHistoryMng.js"></script>
		...
		<div class="acticle">
			...
			<table class="sTable01">
				...
				<tr>
					<th>구분</th>
					<td>
						<select class="select" id="searchDATE_OPTION">
							<option value="M">월별</option>
							<option value="D">일별</option>
						</select>
					</td> 
					<th>이용센터명</th>
					<td><input type="text" class="inp" id="searchCNTER_NM"/></td> 
				</tr> 
				<tr>
					<th>검색일</th>
					<td colspan="3">
